...
public enum MachineType implements IRecipeType<MachineRecipe> {
    ...
    AGGREGATOR(AGGREGATOR_ID, 3, () -> Config.COMMON.aggregator, TripleInputRecipe::new, () -> Serializers.AGGREGATOR),
    CENTRIFUGE(CENTRIFUGE_ID, 1, () -> Config.COMMON.centrifuge, SingleInputRecipe::new, () -> Serializers.CENTRIFUGE),
